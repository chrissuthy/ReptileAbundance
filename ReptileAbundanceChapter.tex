...
markings that can be used to determine individual identity (Sacchi et al. 2010), using tags or markings (Grant \& Doherty 2007) or physical marking such as toe clipping (Paulissen \& Meyer 2000) (see also Chapter X).
...
once provides information about individual detectability, or
...
distance from the observer is measured. Information about detection probability comes from an assumed model for the relationship between detection probability and distance to observer.

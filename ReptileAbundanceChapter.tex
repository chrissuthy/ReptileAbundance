...
al. 2010). The major challenge arises because rarely are all the
individuals in a population encountered during a survey, and that the
...
many individuals have encouter history $\hbox{y}_i = 0$. The ability
